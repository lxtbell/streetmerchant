...
const notifications = {
  ...
  discord: {
    ...
    notifyGroupSeries: {
      ...
      '3070-prebuilt': envOrArray(process.env.DISCORD_NOTIFY_GROUP_3070_PREBUILT, []),
      '3080-prebuilt': envOrArray(process.env.DISCORD_NOTIFY_GROUP_3080_PREBUILT, []),
      'captcha-deterrent': [],
...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      '3070-prebuilt': envOrNumber(process.env.MAX_PRICE_SERIES_3070_PREBUILT, 1500),
      '3080-prebuilt': envOrNumber(process.env.MAX_PRICE_SERIES_3080_PREBUILT, 2000),
      'captcha-deterrent': 0,
